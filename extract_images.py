...
if __name__=="__main__":
    ...
    ("Vaca serrana",13765),("Joell",240394),("LLobarro",34837),("Xucladits",243584),
    ("Castanyoletes",35225),("Fadrí",35194),("Juliola",34835),("Espatarc",35216 ),
    ("Planxeta",34986),("Roqueret",240397),("Tacó",35282),("Bavosa Menuda", 34983),
    ("Bavosa de Plomall", 35250), ("Futarra", 34878), ("Dormilega", 35044), ("Capsigrany", 34989),
    ("Llepissós", 35244), ("Cabot de Roca", 34847), ("Bavosa Morruda",240399)]
    speciesToImg={}
